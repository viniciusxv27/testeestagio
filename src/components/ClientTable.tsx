                ...
                <tr key={client.id}>
                  ...
                  <td className="px-6 text-left py-4 text-sm">
                    <a
                      ...
                      className="buttonDetail px-3 py-2 text-xs font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300"
                    >
                      Ver detalhes
                    </a>
                  </td>
